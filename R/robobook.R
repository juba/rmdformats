...
robobook <- function(fig_width = 8,
  ...
  html_document_args <- list(
    template = system.file("templates/robobook/robobook.html", package = "rmdformats"),
