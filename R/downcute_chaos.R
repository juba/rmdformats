...
downcute_chaos <- function(fig_width = 8,
                       fig_height = 5,
                       fig_caption = TRUE,
                       lightbox = FALSE,
                       thumbnails = FALSE,
    ...
    html_template(
        template_name = "downcute_chaos",
        template_path = "templates/template.html",
        template_dependencies = list(
            html_dependency_downcute_chaos(embed_fonts),
...
html_dependency_downcute_chaos <- function(embed_fonts = TRUE) {
  stylesheets <- "downcute_chaos.css"
  if (embed_fonts) {
    stylesheets <- c(stylesheets, "downcute_chaos_fonts_embed.css")
  } else {
    stylesheets <- c(stylesheets, "downcute_chaos_fonts_download.css")
  }
  htmltools::htmlDependency(name = "downcute_chaos",
                 version = "0.1",
                 src = system.file("templates/downcute_chaos", package = "rmdformats"),
                 script = "downcute_chaos.js",
